Feature: Get "available" pets. Assert expected result
  and Post a new available pet to the store. Assert new pet added.
  and Update this pet status to "sold". Assert status updated.
  Delete the created pet. Assert deletion.
